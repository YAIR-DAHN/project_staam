    ...
    <form id="fromScreen2">
      <fieldset>
        ...
        <div id="selctBook">
          ...
          <input type="radio" id="MegilatEster" name="item1" value="מגילת אסתר" v-model="userData.book" required />
          <label for="MegilatEster">מגילת אסתר</label>
          <input type="radio" id="SeferHaftarot" name="item1" value="ספר הפטרות" v-model="userData.book" required />
